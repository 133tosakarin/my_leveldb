...
class Footer {
 ...
 private:
  // footer point to index_handle_, metaindex_handle_
  // index_handle point to index block
  // metaindex_handle point to meta block
  // each handle is fix length, but it is varint64, so it may be cost 10 bytes
