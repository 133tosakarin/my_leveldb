...
#ifndef STORAGE_MY_LEVELDB_PORT_PORT_STDCXX_H_
#define STORAGE_MY_LEVELDB_PORT_PORT_STDCXX_H_

// port/port_config.h availability is automatically detected via __has_include
// in newer compilers. If MY_LEVELDB_HAS_PORT_CONFIG_H is defined, it overrides the
// configuration detection.
#if defined(MY_LEVELDB_HAS_PORT_CONFIG_H)

#if MY_LEVELDB_HAS_PORT_CONFIG_H
#include "port/port_config.h"
#endif  // MY_LEVELDB_HAS_PORT_CONFIG_H
...
#endif  // defined(MY_LEVELDB_HAS_PORT_CONFIG_H)
...
#endif  // STORAGE_MY_LEVELDB_PORT_PORT_STDCXX_H_