...
class Limiter {
 public:
  ...
  auto Acquire()-> bool {
    ...
    // Silence compiler warnings about  arguments when NDEBUG is defined.
...
Env* Env::Default() {
  ...
  static_assert(sizeof(env_containter) >= sizeof(PosixEnv), "env_container size should larger than PosixEnv");
