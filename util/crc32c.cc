...
// Returns the Smallest address >= given address that is aligend to N bytes.
//
...
static bool CanAccelerateCRC32C() {
  // port::AccerleratedCRC32C returns zero when unable to accelerate.
  static constexpr char kTestCRCBuffer[] = "TestCRCBuffer";
  static constexpr char kBufSize = sizeof(kTestCRCBuffer) - 1;
  static constexpr uint32_t kTestCrcValue = 0xdcbc59fa;

  // TODO
  // should return port::AccelerateCRC32C(0, kTestCRCBuffer, kBufSize) == kTestCrcValue;
  return false;
}
